...
# ============================================================
# Frozen Phase 5 pilot factors
# ============================================================

DATASETS = ["D00", "D05", "D07"]
...
# EXACT SAME 20-environment structure as Phases 2/3/4.
# ============================================================
...
CONFIG = {
    ...
    "purpose": (
        "Phase 5 engineering pilot for D x A x M x S x V"
    ),
}
...
def main():
    ...
    print("=" * 76)
    print("PHASE 5 ENGINEERING PILOT")
    print("=" * 76)
    ...
    print("=" * 76)
    print(
        "PHASE 5 PILOT FINAL INTEGRITY CHECK"
    )
    print("=" * 76)
    ...
    # Each D × A × M combination must have 3 seeds × 20 env = 60 rows.
    dam_counts = (
        final
        .groupby([
            "dataset_id",
    ...
    print("=" * 76)
    print(
        "PHASE 5 ENGINEERING PILOT: PASS"
    )
    print("=" * 76)
